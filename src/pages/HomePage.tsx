  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="py-12 text-center">
        ...
        <h1 className="text-3xl font-medium text-gray-800 leading-snug mb-3">
        ...
        <div className="flex items-center justify-center gap-2">
          <Link to="/build" className="inline-flex items-center gap-1.5 bg-[#3B6D11] text-[#EAF3DE] text-sm font-medium px-5 py-2.5 rounded-lg">
          ✏️ 作成をはじめる
          </Link>
          <button className="inline-flex items-center gap-1.5 bg-white text-gray-700 text-sm px-5 py-2.5 rounded-lg border border-gray-200">
            👁️ サンプルを見る
          </button>
        </div>
      </div>
